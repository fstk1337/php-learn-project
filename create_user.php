<?php
    ...
    if (is_not_logged_in() || !is_admin(get_user_id())) {
        set_message("danger","Для добавления нового пользователя необходимо войти под учетной записью администратора.");
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input type="text" name="vklink" class="form-control border-left-0 bg-transparent pl-0">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- telegram -->
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input type="text" name="tglink" class="form-control border-left-0 bg-transparent pl-0">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- instagram -->
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input type="text" name="instalink" class="form-control border-left-0 bg-transparent pl-0">
                                        </div>
                                    </div>
