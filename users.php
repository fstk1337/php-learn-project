                            ...
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <div class="info-card-text flex-1">
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        <?php echo $user["name"]; ?>
                                        <?php if(is_admin(get_user_id()) || get_user_id() == $user["id"]):?>
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="edit.php<?php echo "?id=" . $user["id"];?>">
                                            <i class="fa fa-edit"></i>
                                        Редактировать</a>
                                        <a class="dropdown-item" href="security.php<?php echo "?id=" . $user["id"];?>">
                                            <i class="fa fa-lock"></i>
                                        Безопасность</a>
                                        <a class="dropdown-item" href="status.php<?php echo "?id=" . $user["id"];?>">
                                            <i class="fa fa-sun"></i>
                                        Установить статус</a>
                                        <a class="dropdown-item" href="media.php<?php echo "?id=" . $user["id"];?>">
